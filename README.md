...
| Pinia | состояние (каталог, корзина, избранное, toast) |
| Axios | HTTP |
...
- **Админ** (`/admin`): таблица всех товаров с API, фильтр по категории из данных, сортировка по названию / цене / рейтингу, клиентская пагинация, SCSS.
